...
class FindShortestPath66_6  //Shortest path algorithm
{
    public static void main(String A[])
    {    
        HashMap<String, ArrayList<String>> hobj = new HashMap<String, ArrayList<String>>();

        ArrayList<String> listA = new ArrayList<String>(); //Adding values 
        listA.add("Rahul");
        hobj.put("Amit",listA);
        ...
        while(!qobj.isEmpty())
        {
            ...
            if(hobj.containsKey(current)) //filter
            {
                for(String friend : hobj.get(current)) //stores given keys value in friend
                {
